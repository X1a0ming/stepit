...
STEPIT_REGISTER_FIELD_SOURCE(joint_reordering, kDefPriority, FieldSource::makeDerived<JointReordering>);
STEPIT_REGISTER_FIELD_SOURCE(action_reordering, kDefPriority, FieldSource::makeDerived<ActionReordering>);
}  // namespace neuro_policy
}  // namespace stepit
