...
STEPIT_REGISTER_FIELD_SOURCE(action_history, kDefPriority, FieldSource::makeDerived<ActionHistory>);
STEPIT_REGISTER_SOURCE_OF_FIELD(action_p1, kDefPriority, FieldSource::makeDerived<ActionHistory>);
STEPIT_REGISTER_SOURCE_OF_FIELD(action_p2, kDefPriority, FieldSource::makeDerived<ActionHistory>);
STEPIT_REGISTER_FIELD_SOURCE(action_filter, kDefPriority, FieldSource::makeDerived<ActionFilter>);
}  // namespace neuro_policy
}  // namespace stepit
