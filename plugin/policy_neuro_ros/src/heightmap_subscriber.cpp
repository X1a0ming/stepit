...
STEPIT_REGISTER_FIELD_SOURCE(heightmap_subscriber, kDefPriority, FieldSource::makeDerived<HeightmapSubscriber>);
STEPIT_REGISTER_SOURCE_OF_FIELD(heightmap, kDefPriority, FieldSource::makeDerived<HeightmapSubscriber>);
STEPIT_REGISTER_SOURCE_OF_FIELD(heightmap_uncertainty, kDefPriority, FieldSource::makeDerived<HeightmapSubscriber>);
}  // namespace neuro_policy
}  // namespace stepit
