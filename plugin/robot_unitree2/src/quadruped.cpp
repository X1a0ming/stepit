...
namespace stepit {
constexpr std::array<std::size_t, 16> B2WSpec::kMotorIndices;
constexpr std::array<float, 16> B2WSpec::kMotorDirections;
...
STEPIT_REGISTER_ROBOTAPI(b2w, kDefPriority, RobotApi::make<B2WApi>);
